    ...
    <>
      <div className="flex items-center flex-col flex-grow pt-10">
        {isEthToTokenEventsLoading ? (
          ...
          <div>
            <div className="text-center mb-4">
              <span className="block text-2xl font-bold">ETH To Scroogecoin Events</span>
            </div>
              ...
              <table className="table table-zebra w-full">
                <thead>
                  <tr>
                    ...
                    <th className="bg-primary">Amount of Scroogecoin out</th>
                  </tr>
                </thead>
                <tbody>
        ...
        {isTokenToEthEventsLoading ? (
          ...
          <div className="mt-8">
            <div className="text-center mb-4">
              <span className="block text-2xl font-bold">Scroogecoin To ETH Events</span>
            </div>
            <div className="overflow-x-auto shadow-lg">
              <table className="table table-zebra w-full">
                <thead>
                  <tr>
                    <th className="bg-primary">Address</th>
                    <th className="bg-primary">Amount of Scroogecoin In</th>
